 ...
 * 	Encrypt the input byte array with this secretKey
 * 	Decrypt the encrypted plainText with this secretKey
 * 	Decrypt the encrypted byte array with this secretKey
...
public class AESEncryption
{
  ...
  /** Instantiate Cipher with ENCRYPT_MODE, this uses the secretKey to encrypt the bytes.
   @param data the input of the user to be encrypted
   @param secretKey is the key to encrypt the plainText
   @return encryted byte array
   **/
   ...
   *
   * @param encryptedText that is encrypted with secretKey
   * @param secretKey is the key to decrypt the encryptedText
  ...
  /**Instantiate Cipher with DECRYPT_MODE, this uses the same secretKey to decrypt the bytes.
   *
   * @param encryptedData that is encrypted with secretKey
